...
RUN sed -i "1isqlite3 -header -line \"/config/Library/Application Support/Plex Media Server/Plug-in Support/Databases/com.plexapp.plugins.library.db\" \"PRAGMA default_cache_size = 1000000\"" /etc/services.d/plex/run
